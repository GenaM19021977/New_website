...
class Delivery(models.Model):
    ...
    title = models.CharField(
        ...
        help_text=(
            "Checkout (курьер): id=2 — Брест и сумма заказа меньше числового значения → стоимость из суммы строки; "
            "id=1 — Брест и сумма больше числового значения → стоимость из суммы строки (проверка после id=2). "
    ...
    value_number = models.DecimalField(
        ...
        help_text=(
            "Для id=1 при Бресте: порог «сумма больше». Для id=2: порог «сумма меньше». "
    ...
    amount = models.DecimalField(
        ...
        verbose_name="Сумма",
        help_text=(
            "Для id=1 (Брест, сумма больше порога) и id=2 (Брест, сумма меньше порога): стоимость доставки BYN. "
