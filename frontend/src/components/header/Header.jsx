...
export default function Header(props) {
  ...
  const menuItems = [
    ...
    {
      label: isAuthenticated ? "Личный кабинет" : "Войти",
      path: isAuthenticated ? ROUTES.CABINET : ROUTES.LOGIN,
    },
  ];
          ...
          <div className="header-nav-row">
            ...
            <nav className="desktop-menu" aria-label="Основная навигация">
              ...
              <div className="header-catalog-dropdown">
                <Link
                  to={ROUTES.CATALOG}
                  className="header-link header-link-with-dropdown"
                  onClick={scrollToTop}
                >
                  Каталог
      ...
      <Drawer
        ...
        sx={{
          ...
          "& .MuiListItemButton-root:hover": {
            color: "#C7A75A",
            backgroundColor: "rgba(199, 167, 90, 0.1)",
          },
        }}
      >
        <List>
